...
BUCKET_NAME = "saranfinalbucket"  # Name of the S3 bucket
...
# RDS Configuration
RDS_HOST = "userlogs.c7s0acu26t7j.ap-south-1.rds.amazonaws.com"  # RDS endpoint
RDS_USER = "admin"  # Database username
RDS_PASSWORD = "saran12345"  # Database password
